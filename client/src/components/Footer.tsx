      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2026 Jealous Fork. All rights reserved. | <Link href="/privacy"><a className="hover:text-gray-200 transition-colors">Privacy Policy</a></Link> | <Link href="/terms"><a className="hover:text-gray-200 transition-colors">Terms of Service</a></Link></p>
          </div>
        </div>
      </footer>
    </>
