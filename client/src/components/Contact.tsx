      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="font-playfair text-4xl md:text-5xl font-bold mb-6 text-gray-900">
            Visit Us <span className="text-warm-amber">Today</span>
          </h2>
          ...
          <div className="space-y-8">
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  <svg className="w-6 h-6 text-warm-amber mr-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button 
                  type="submit" 
                  className="w-full bg-warm-amber text-white py-3 px-6 rounded-lg font-semibold hover:bg-warm-amber/90 transition-colors"
                >
                  Send Message
                </button>
              </form>
