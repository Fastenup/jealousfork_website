...
export default function Home() {
  return (
    <>
      <SEOHead
        title="Best Pancakes in Miami & Breakfast Kendall | Jealous Fork"
        description="Best pancakes in Miami and top breakfast in Kendall. Jealous Fork serves artisan brunch favorites with 4.7★ reviews. View menu, reserve, or order pickup today."
