...
export default function Home() {
  return (
    <>
      <SEOHead
        title="Jealous Fork Menu: Best Pancakes, Breakfast & Brunch in Miami"
        description="Jealous Fork menu in Kendall, Miami: artisan pancakes, brunch favorites, and gourmet burgers. ★4.7 Google ★4.6 Yelp. Open Tue-Sun 9AM. Order pickup online."
